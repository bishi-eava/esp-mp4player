...
#if defined(BOARD_ATOMS3R) || defined(BOARD_ATOMS3R_SPK) || defined(BOARD_ATOMS3R_ECHO)
...
#elif defined(BOARD_ATOMS3R) || defined(BOARD_ATOMS3R_SPK) || defined(BOARD_ATOMS3R_ECHO)
